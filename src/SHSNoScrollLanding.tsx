 ...
 <div className="relative h-dvh w-full overflow-hidden
      ...
      <div className="relative z-10 mx-auto max-w-7xl h-full px-5 grid grid-rows-[1fr_auto] sm:grid-rows-1 sm:grid-cols-2 gap-6 items-center">
        ...
        <div className="max-w-xl">
          ...
          <a href="https://trading.shs.com.vn/" target="_blank"> 
            <button className="relative overflow-hidden rounded-2xl px-6 py-3 font-semibold text-white
              ...
              hover:bg-orange-600 hover:shadow-[0_0_35px_rgba(252,214,83,0.6)]
              transition duration-300 ease-out
              dark:bg-orange-200/10 dark:border-orange-200/30
              dark:hover:bg-orange-200/20">
        ...
        >
          ...
          <div className="relative isolate rounded-3xl h-[420px]">
      ...
      <div className="absolute bottom-3 left-0 right-0 z-20 text-slate-700 dark:text-white/75">
