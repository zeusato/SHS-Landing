...
function LegacyV1() {
  ...
  return (
    <div className="relative h-full">
      ...
      {/* grid */}
      <div className="relative z-10 mx-auto max-w-7xl min-h-[calc(100dvh-96px)] px-5 grid grid-rows-[auto_auto] sm:grid-rows-1 sm:grid-cols-2 gap-6 items-start py-10 pt-10 sm:pt-15">
        {/* chart */}
